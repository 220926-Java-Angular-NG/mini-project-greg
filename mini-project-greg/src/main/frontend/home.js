...
nameDisplay.innerHTML = `Welcome, ${currentUser.firstname} ${currentUser.lastname}!`;

let starDisplay = document.getElementById("star-sign-display");
starDisplay.innerHTML = `Your sign is ${currentUser.zodiac}!`;
...
function addHoroToPage(json_data){
    ...
    todayHoro.innerHTML = `Horoscope of the day: ${json_data.horoscope}`
